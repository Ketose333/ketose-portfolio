(() => {
  ...
  function bindBoardInspectLongPress() {
    ...
    boardPointerEndHandler = clearBoardLongPress;

    document.body.addEventListener('pointerdown', boardPointerDownHandler);
    document.body.addEventListener('pointerup', boardPointerEndHandler);
    document.body.addEventListener('pointercancel', boardPointerEndHandler);
  ...
  function teardown() {
    ...
    if (boardPointerDownHandler) {
      document.body.removeEventListener('pointerdown', boardPointerDownHandler);
      boardPointerDownHandler = null;
    }
    if (boardPointerEndHandler) {
      document.body.removeEventListener('pointerup', boardPointerEndHandler);
      document.body.removeEventListener('pointercancel', boardPointerEndHandler);
      document.body.removeEventListener('pointerleave', boardPointerEndHandler);
      boardPointerEndHandler = null;
    }
