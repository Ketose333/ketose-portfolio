...
const { createUser, verifyUser, createSession, deleteSession, getUserPublic, getAuthUser, setSessionCookie, clearSessionCookie } = require('../lib/auth-service');
...
module.exports = async (req, res) => {
  try {
    ...
    console.error('[nulsight][auth]', error);
    return sendServerError(res, 'AUTH_SERVER_ERROR');
  }
};
