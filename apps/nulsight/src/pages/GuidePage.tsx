  ...
  return (
    <NulsightPageFrame className="nulsight-shell nulsight-shell--reading" width="reading">
      <section className="nulsight-page-main">
        <section className="nulsight-panel nulsight-panel--hero nulsight-panel--compact" aria-label="기본 규칙">
          <SectionIntro
            ...
            description={
              <p className="nulsight-copy nulsight-copy--tight">
                턴 구조와 기본 조작, 핵심 키워드만 먼저 익히면 바로 테스트 플레이가 가능합니다.
              </p>
            }
          ...
          <div className="nulsight-band-list nulsight-band-list--guide">
            ...
            <article className="nulsight-band">
              ...
              <strong className="nulsight-band__value">{keywordCatalog.length ? `${keywordCatalog.length}개 용어 로드됨` : '불러오는 중'}</strong>
            </article>
            <article className="nulsight-band">
              <span className="nulsight-band__label">존 순서</span>
              <strong className="nulsight-band__value">좌→우 M1~M3 / S1~S4</strong>
            </article>
          </div>
        </section>
