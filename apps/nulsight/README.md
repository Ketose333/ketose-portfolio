...
- `src/`
  ...
  - router composition now mirrors `amesato`: `AppRouter` owns `BrowserRouter`, and `NulsightAppShell` handles route-wide chrome/audio sync
- `src/shared/`
...
- `public/core.css`
  - shared runtime styles used by the React app
- `docs/`
